...
class IrisFlower(BaseModel): 
    ...
    def cache_key(self):
        raw = json.dumps(self.model_dump(), sort_keys=True) # It converts the validated request data into a stable JSON string with a guaranteed key order.
...
# json.dumps()	String--------------------> Python dict → JSON string
# json.loads()	String / bytes------------>	JSON string → Python dict